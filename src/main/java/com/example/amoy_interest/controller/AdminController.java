...
//        return new Msg<>(MsgCode.SUCCESS, MsgUtil.SUCCESS_MSG, userService.getReportedUsers());
    ...
    public Msg Unban(@RequestBody @NotNull(message = "用户id不能为空") @Min(value = 1, message = "用户id不能小于1") Integer user_id) {
    ...
    public Msg Permit(@RequestBody @NotNull(message = "用户id不能为空") @Min(value = 1, message = "用户id不能小于1") Integer user_id) {
