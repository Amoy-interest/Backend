...
import com.example.amoy_interest.config.shiro.cache.CustomCacheManager;
import com.example.amoy_interest.config.shiro.jwt.JwtFilter;
...
//        //获取热榜接口放开
//        filterChainDefinitionMap.put("/topics/hotList", "anon");
//        //获取未登录前博文接口放开
//        filterChainDefinitionMap.put("/blogs/beforeLogin", "anon");
